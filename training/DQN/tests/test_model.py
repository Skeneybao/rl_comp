    ...
    def test_inference(self):
        for i in range(100):
            ...
            action, model_input, model_output = model_output_wrapper.select_action(
                model, self.state, feature_engine.get_feature(self.state))
